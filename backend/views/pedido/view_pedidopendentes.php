...
<div class="card card-solid">
    <div class="card-body pb-0">   <h1>        <img  src="http:\\localhost\advanced1\images\create\pedido.png" alt="AdminLTE Logo" class=""  width="100" height="100" style="opacity: .8">
        ...
        $allPedidos = \backend\models\Pedido::find()->orderBy(['data' => SORT_DESC ])->where(['idrestaurantepedido' => Yii::$app->user->identity->restauranteid])->andWhere(['estadopedido'=>["Pendente"]])->all();
