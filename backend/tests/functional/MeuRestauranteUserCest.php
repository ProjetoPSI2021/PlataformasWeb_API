...
class MeuRestauranteUserCest
{
    ...
    public function pedidosUsernormal(FunctionalTester $I)
    {
        $I->loadSessionSnapshot('loginUsernormal');
        $I->amOnPage('advanced1/backend/web/index.php');
        $I->wait(5);
    ...
    public function comidaUsernormal(FunctionalTester $I)
    {
        $I->loadSessionSnapshot('loginUsernormal');
        $I->amOnPage('advanced1/backend/web/index.php');
        $I->wait(5);
    ...
    public function reservaUsernormal(FunctionalTester $I)
    {
        $I->loadSessionSnapshot('loginUsernormal');
        $I->amOnPage('advanced1/backend/web/index.php');
        $I->wait(5);
